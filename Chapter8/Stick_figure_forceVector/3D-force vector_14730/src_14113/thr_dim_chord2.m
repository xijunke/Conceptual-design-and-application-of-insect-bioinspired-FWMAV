...
% pitch_AOA=xlsread('D:\KXJ\Passive_rot_dynamic_fruitfly\PassiveRot_angle_Alpha.xlsx','A1:D12000'); % 读入数据
pitch_AOA=xlsread('D:\KXJ\PassiveRot_dynamic_Science_fruitfly\wing_parameter\datanalysis_science_fruitfly\wing_model\Stick_figure\PassiveRot_angle_Alpha.xlsx','A1150:D3170');
...
xlswrite('D:\KXJ\PassiveRot_dynamic_Science_fruitfly\wing_parameter\datanalysis_science_fruitfly\wing_model\Stick_figure\wingmotion_oneT.xlsx',A,'sheet1','A1:G2000');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 将单个稳定的周期的总(合成)法向气动力数据读入——mN
% 以备thr_dim_chord2程序的调用用于绘制球棍图——翅坐标系下的法向力失终点y坐标
F_normal1=xlsread('D:\KXJ\PassiveRot_dynamic_Science_fruitfly\wing_parameter\datanalysis_science_fruitfly\wing_model\Stick_figure\Forcenormal_oneT.xlsx','A1:A2000');
