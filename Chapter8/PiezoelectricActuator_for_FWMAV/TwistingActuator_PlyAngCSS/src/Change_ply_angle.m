%% Change_ply_angle
clear all; clc;
E1=350*10^9; E2=7*10^9;  E=62*10^9; 
v12=0.33;  v21=v12*E2/E1;  v=0.34;
d31=-320*10^(-12);  d32=d31;   d33=0;
E3=300; % Strength of electric field
L=0.01;  W=0.002;   H=127/10^6;
rho=7800;
m=L*W*H*rho;
%% Change the ply angle
g=1;  % Index
for gamma=0:90;
...
z1=-(127/10^6)/2;
z2=-z1;
z3=z2+80/10^6;  %Thickness of  CF layer is 80¦Ìm
z0=-z3;
...
kxy(g)=C(6,1)*N1+C(6,2)*N2+C(6,3)*N3;
theta(g)=atan(kxy(g)*L)*180/pi;
tau(g)=W*(C(6,1)*N1+C(6,2)*N2+C(6,3)*N3)/C(6,6);
Ed(g)=0.5*tau(g)*theta(g)/m;
g=g+1;  % Index+1
end
