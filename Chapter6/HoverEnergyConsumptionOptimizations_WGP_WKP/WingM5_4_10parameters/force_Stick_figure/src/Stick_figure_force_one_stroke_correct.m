...
% xlswrite('D:\KXJ\PassiveRot_dynamic_Science_fruitfly\optimal\optimal_wing_para_motion\t_psi_phi_alpha_3T.xlsx',Angle,'sheet1','A1:D1000');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% (2) 截取单个稳定的周期——以攻角变化周期为区间
% 采用攻角为90度对应时刻为上下冲程的结束时间点
% [psi_sim_0, locat_0]=min(abs(psi_sim));   % psi_sim_0 =6.2058e-004; locat_0 =3;
% [psi_sim_0, locat_0]=min(abs(psi_sim(1:150,1)))   % psi_sim_0=0.0060;  locat_0=144;
% psi_sim_0*180/pi  %  ans =0.3419;
[psi_sim_0, locat_0]=min(abs(psi_sim(250:350,1)));   % psi_sim_0=0.0062;  locat_0=61;
% psi_sim_0*180/pi          % ans =0.3567
locat_0=locat_0+250-1;   % locat_0=310;
T=1/f;
t_T=t(locat_0)+T;
...
% F_normal=xlsread('D:\KXJ\PassiveRot_dynamic_Science_fruitfly\optimal\optimal_wing_para_motion\Forcenormal_3T.xlsx','A1:D1000');
...
for i = 1:1:N_down   % N_down=15
    ...
    h2=text(-1.85,2.2,'for combined optimized wing geometry and kinematics');
