...
options=gaoptimset('Display','iter','PopulationSize',100,'Generations',300,...   % 回复继续搜索，将代数=200修改为代数=5+10
...
xlswrite('D:\kxj\WingM5_4_10variable_group\population_scores.xlsx',output_1,'sheet1','A1:K100');
