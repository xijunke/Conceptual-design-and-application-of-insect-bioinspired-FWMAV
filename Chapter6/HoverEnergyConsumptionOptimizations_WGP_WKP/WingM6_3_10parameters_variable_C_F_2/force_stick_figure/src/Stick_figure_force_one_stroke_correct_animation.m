...
psi_sim=-wing_kenimatics(:,3);              % 拍打角——单位是rad——————注意加了负号
...
F_ytran=-F_normal((locat_0:num),1);         %  被缩小了0.1倍显示quiver3 ——————注意加了负号
F_yadd=-F_normal((locat_0:num),2);         %  被缩小了0.1倍显示quiver3——————注意加了负号
F_yrot=-F_normal((locat_0:num),3);          %  被缩小了0.1倍显示quiver3——————注意加了负号
...
for i = 1:1:N_down   % N_down=15
   ...
   h2=text(-3.0,3.25,'for combined optimal WGP and WKP with 3D translational aerodynamic coefficients');
