...
% LB = [0,0,0.0001,0,-inf,-pi/2, 2, 0.5, 0, 0];              % Lower bound    K>=0.0001
% UB = [1000,pi/2,1,pi/2,inf,0, 4, 2, 2, 0.356737];  % Upper bound
LB = [0,0,0.0001,0,0,-pi/2, 2, 0.5, 0, 0];              % Lower bound    K>=0.0001
UB = [1000,75*pi/180,1,pi/2,5,0, 4, 2, 2, 0.356737];  % Upper bound
...
% LB =[0,     0,    -pi, 0,    -pi,  -pi/4, 2, 0.5, 0, 0];              % Lower bound   % 10个变量    % for 谐波函数wingbeat  pattern
% UB=[300, pi/2, pi, pi/2, pi,   pi/4,  4, 2,   2, 0.35];          % Upper bound   % 10个变量     % for 谐波函数wingbeat  pattern
